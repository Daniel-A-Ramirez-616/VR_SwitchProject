...
public class InputPoller : MonoBehaviour
{
    ...
    public InputData GetInputP1()
    {
        ...
        if (kb != null)
        {
            ...
            input.leftShoulder = kb.spaceKey.wasPressedThisFrame;
            //input.rightShoulder = kb.eKey.wasPressedThisFrame;
    ...
    public InputData GetInputP2()
    {
        ...
        if (kb != null)
        {
            ...
            input.leftShoulder = kb.uKey.wasPressedThisFrame;
            input.rightShoulder = kb.oKey.wasPressedThisFrame;
